...
export default function CheckoutPage({
  ...
  const poll = useCallback(async () => {
    try {
      ...
      // Generate QR once we have the invoice
      if (json.bolt11 && !qrDataUrl) {
        QRCode.toDataURL(`lightning:${json.bolt11.toUpperCase()}`, {
          width: 256,
          margin: 2,
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-6">
          ...
          {qrDataUrl ? (
            ...
            <div className="flex justify-center">
              <div className="w-[220px] h-[220px] rounded-xl border border-gray-700 flex items-center justify-center">
          ...
          <p className="text-center text-xs text-gray-600">
            Invoice expires in ~10 minutes. Page updates automatically after payment.
          </p>
        </div>
